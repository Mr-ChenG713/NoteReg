...
public class WindTy extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewTipo = (RecyclerView) findViewById(R.id.recyclerViewTipos);
        adaptadorTipo = new AdaptadorTipo(this);
        recyclerViewTipo.setAdapter(adaptadorTipo);
        recyclerViewTipo.setLayoutManager(new LinearLayoutManager(this));
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        ...
        Snackbar.make(recyclerViewTipo, "Dados Exixtentes:  " + data.getCount(), Snackbar.LENGTH_INDEFINITE).show();
        adaptadorTipo.setCursor(data);
