...
public class WindMov extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewMovimentos.setAdapter(adaptadorMovimento);
    ...
    public void refreshMenuOptions() {
        ...
        boolean mostraAlterarEliminar = (movimento != null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent intent = new Intent(this, EditMov.class);
            intent.putExtra(ID_MOVIMENTO, adaptadorMovimento.getMovimentoSelecionado().getId());
            startActivity(intent);
            return true;
            ...
            Intent intent = new Intent(this, DelMov.class);
            intent.putExtra(ID_MOVIMENTO, adaptadorMovimento.getMovimentoSelecionado().getId());
            startActivity(intent);
            return true;
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        CursorLoader cursorLoader = new CursorLoader(this, NoteRegContentProvider.ENDERECO_MOVIMENTO, BdTableMovimento.TODAS_COLUNAS_MOVIMENTOS, null, null, BdTableMovimento.CAMPO_TIPO
        );
