...
public class BdTableMovimento implements BaseColumns {
    ...
    public static final String ALIAS_NOME_TIPO = "nome_servico";
    ...
    public static final String[] TODAS_COLUNAS_MOVIMENTOS = new String[] { NOME_TABELA + "." + _ID, CAMPO_TIPO, CAMPO_SERVICO,CAMPO_DATA, CAMPO_MONTANTE, CAMPO_DESCRICAO, CAMPO_TIPO, CAMPO_SERVICO, CAMPO_NOME_TIPO, CAMPO_NOME_SERVICO};
